...
public enum FileType {
   ...
   * The specific configuration of the JavaPropsMapper used by Params4J can be found in {@link uk.co.spudsoft.params4j.impl.Params4JImpl#createPropsMapper(java.util.List, java.util.List)}.
   * 
   ...
   * The specific configuration of the ObjectMapper used by Params4J can be found in {@link uk.co.spudsoft.params4j.impl.Params4JImpl#createYamlMapper(java.util.List, java.util.List)}.
   * 
