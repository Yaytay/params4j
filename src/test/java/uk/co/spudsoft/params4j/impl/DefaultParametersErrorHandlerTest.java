...
public class DefaultParametersErrorHandlerTest {
  ...
  private ObjectMapper createJsonMapper() {
    ...
    mapper.addHandler(new DefaultParametersErrorHandler());
  ...
  public void testHandleWeirdNativeValue() throws Exception {
    String json = "{\"list\":{}}";
    logger.debug("testHandleWeirdNativeValue: {}", json);
    DummyParameters result = mapper.readValue(json, DummyParameters.class);
  }
  ...
  public void testHandleWeirdNumberValue() throws Exception {
    ...
    logger.debug("testHandleWeirdNumberValue: {}", json);
    DummyParameters result = mapper.readValue(json, DummyParameters.class);
    logger.debug("Value: {}", mapper.writeValueAsString(result));
  }
  ...
  public void testHandleWeirdStringValue() throws Exception {
    String json = "{\"list\":[\"asdf\"]}";
    logger.debug("testHandleWeirdStringValue: {}", json);
    DummyParameters result = mapper.readValue(json, DummyParameters.class);
    logger.debug("Value: {}", mapper.writeValueAsString(result));
  }
